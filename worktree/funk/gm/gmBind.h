...
// GMF CONSTRUCTOR
#define GM_PUSH_NEW_USER( TYPE, PTR ) GM_THREAD_ARG->PushNewUser( PTR, GM_TYPEID(TYPE) );
#define GM_PUSH_USER_HANDLED( TYPE, PTR ) { TYPE* _ptr = (PTR); _ptr->AddRef(); GM_PUSH_NEW_USER( TYPE, _ptr ); }
